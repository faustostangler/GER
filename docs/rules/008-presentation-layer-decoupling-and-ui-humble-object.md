...
4. **State Management Isolation**: Component states (keys used in `st.session_state`) must be returned by the builders to the maestro layer to maintain visibility of global state context.
